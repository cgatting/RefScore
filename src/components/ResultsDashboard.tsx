  ...
  return (
    <div id="dashboard-content" className="space-y-8 pb-12 animate-fade-in bg-slate-950 p-8">
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between pdf-section">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto" data-html2canvas-ignore>
          <button 
            ...
            className="px-5 py-2.5 text-sm font-bold text-slate-950 bg-brand-600 hover:bg-brand-500 rounded-xl shadow-lg shadow-brand-500/20 hover:shadow-brand-500/30 transition-all flex items-center gap-2 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed">
            {isExporting ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 pdf-section">
        {/* Main Score */}
        <div className="col-span-1 md:col-span-2 bg-slate-900 rounded-3xl p-8 text-white shadow-xl border border-slate-800">
        ...
        <div className="glass-card rounded-3xl p-6 flex flex-col justify-between hover:border-brand-500/30 group">
          ...
          <div>
            <div className="text-4xl font-display font-bold text-white mt-4">{validReferences.length}</div>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              <div className="relative flex-1 md:w-64">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-2 text-sm bg-slate-800 border border-slate-700 text-white rounded-xl focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all shadow-sm placeholder:text-slate-600"
                />
              </div>
