...
export const LandingPage: React.FC<LandingPageProps> = ({ onStart }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-brand-500/30 selection:text-brand-100 overflow-x-hidden">
      {/* Navigation */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3">
              <div className="bg-black p-3 rounded-2xl shadow-lg shadow-brand-500/30 ring-2 ring-brand-500/30 hover:ring-brand-500/50 hover:shadow-brand-500/50 transition-all duration-300">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-display font-bold text-white mb-8 leading-tight tracking-tight animate-fade-in-up">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="mt-10">
                <button 
                  onClick={onStart}
                  className="px-6 py-3 bg-brand-600 hover:bg-brand-500 text-slate-950 font-bold rounded-lg transition-colors shadow-lg shadow-brand-500/20"
                >
